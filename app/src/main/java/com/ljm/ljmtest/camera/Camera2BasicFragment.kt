...
class Camera2BasicFragment : Fragment(), View.OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private fun openCamera(width: Int, height: Int) {
        ...
        if(permission != PackageManager.PERMISSION_GRANTED){
            ...
            requestPermissions(arrayOf(Manifest.permission.CAMERA), 7890)
            return
        }
    ...
    override fun onViewCreated(v: View, savedInstanceState: Bundle?) {
        v.findViewById<Button>(R.id.picture).setOnClickListener(this)
        v.findViewById<ImageButton>(R.id.info).setOnClickListener(this)
        textureView = v.findViewById(R.id.texture)
    }

    override fun onActivityCreated(savedInstanceState: Bundle?) {
        super.onActivityCreated(savedInstanceState)
        file = File(activity!!.getExternalFilesDir(null), "ljm_test_picture.jpg")
    }
        ...
        try {
            ...
            val captureCallback = object : CameraCaptureSession.CaptureCallback() {
                ...
                override fun onCaptureCompleted(session: CameraCaptureSession,
                    ...
                    LjmUtil.D("Saved: $file")
                    LjmUtil.D(file.toString())
                    unlockFocus()
                }
            }
    ...
    private fun areDimensionsSwapped(displayRotation: Int): Boolean {
        ...
        when (displayRotation) {
            ...
            Surface.ROTATION_90, Surface.ROTATION_270 -> {
                ...
                LjmUtil.D("Display rotation is invalid: $displayRotation")
            }
        }
    ...
    companion object{
        ...
        @JvmStatic private fun chooseOptimalSize(
            ...
            if (bigEnough.size > 0) {
                ...
                LjmUtil.D("Couldn't find any suitable preview size")
                return choices[0]
            }
        }
